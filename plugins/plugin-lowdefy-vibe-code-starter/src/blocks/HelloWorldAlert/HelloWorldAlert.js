...
HelloWorldAlertBlock.defaultProps = blockDefaultProps;
HelloWorldAlertBlock.meta = {
  category: 'container',
  icons: [],
  styles: ['blocks/HelloWorldAlert/style.less'],
};

export default HelloWorldAlertBlock;
